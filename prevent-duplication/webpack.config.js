...
module.exports = {
    ...
    optimization: {
        splitChunks: {
            ...
            minSize: 0,
            //peso que debe tener, en este caso al ser 0, todo archivo duplicado va a commons sin importar peso
            name: 'commons'
            //nombre del archivo donde estará agrupado el código repetido
        }
    }
}